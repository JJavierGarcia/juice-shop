      ...
      .then(async (basket: BasketModel | null) => {
        if (basket != null) {
          ...
          db.ordersCollection.insert({
            ...
            paymentId: req.body.orderDetails.toString() ? req.body.orderDetails.paymentId.toString() : null,
            addressId: req.body.orderDetails.toString() ? req.body.orderDetails.addressId.toString() : null,
            orderId,
            delivered: false,
